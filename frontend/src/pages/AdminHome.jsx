...
const AdminHome = () => {
  ...
  },
  {
    ...
    const fetchAiInsights = async () => {
        ...
        setTimeout(() => {
            setAiInsight({
                summary: "School-wide academic health remains stable at an 84% average. However, minor attendance anomalies have triggered system alerts.",
                alerts: [
                    { id: 1, type: "danger", message: "15% drop in attendance in Batch B over the last 14 days." },
                    { id: 2, type: "warning", message: "Backend Dev course has 4 students tracking 20% below passing average." }
                ]
            });
